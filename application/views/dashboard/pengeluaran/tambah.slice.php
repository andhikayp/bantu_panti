...
<nav class="breadcrumb bg-white push">
    ...
    <a class="breadcrumb-item" href="{{ base_url('/PengeluaranController/index') }}">Riwayat Pengeluaran</a>
    <span class="breadcrumb-item active">Tambah Pengeluaran</span>
</nav>
<div class="block">
    <div class="block-header block-header-default bg-primary">
        <h3 class="block-title">Tambah Pengeluaran</h3>
    </div>
    <div class="block-content">
        <form class="js-validation-signup px-30" method="POST" enctype="multipart/form-data" action="{{ base_url('PengeluaranController/tambahPengeluaran/') }}" aria-label="">
            ...
            <hr/><div class="row mb-2">
                <div class="col-3"></div>
                    <a class="col-3 btn btn-danger" href="{{ base_url('PengeluaranController/index/') }}">Cancel</a>&nbsp
