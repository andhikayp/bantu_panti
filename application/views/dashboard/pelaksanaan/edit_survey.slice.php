...
<nav class="breadcrumb bg-white push">
    ...
    <span class="breadcrumb-item active">Update Pelaksanaan Survey</span>
</nav>
<div class="block">
    <div class="block-header block-header-default bg-primary">
        <h3 class="block-title">Update Pelaksanaan Survey</h3>
    </div>
    <div class="block-content">
        <form class="js-validation-signup px-30" method="POST" enctype="multipart/form-data" action="{{ base_url('PetugasController/edit_survey/'.$petugas->id) }}" aria-label="">
                    ...
                    <div class="form-material form-material-primary floating open">
                        <select class="form-control js-example-basic-single3" id="tempat_pelaksanaan" name="tempat_pelaksanaan">
                            ...
                            @foreach($sekolah as $pelaksanaan)
                                <option value="{{ $pelaksanaan->nama_sekolah }}">{{ $pelaksanaan->nama_sekolah }}</option>
                            @endforeach
                        </select>
            ...
            <div class="form-group row">
                <div class="col-12">
                    <div class="form-material form-material-primary floating input-group">
                        <input value="{{ $petugas->pihak_sekolah}}" type="text" class="form-control" id="pihak_sekolah" name="pihak_sekolah">
            ...
            <div class="form-group row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <br>
                        <input value="{{ $petugas->tanggal}}" type="date" id="tanggal" class="form-control form-control-alternative" name="tanggal" required>
                            </select>
                    </div>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <br>
                        <input value="{{ $petugas->jam}}" type="time" id="jam" class="form-control form-control-alternative" name="jam" required>
                            </select>
                    </div>
                </div>
            </div>
            <hr/><div class="row mb-2">
                <div class="col-3"></div>
                    <a class="col-3 btn btn-danger" href="{{ base_url('PetugasController/edit_survey/'.$petugas->id) }}">Cancel</a>&nbsp
